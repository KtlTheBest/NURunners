...
public final class a extends g
{
    ...
    public a(final String s, final w w, final s s2, final e e, final String pathname) {
        super(s, w, s2, e);
    ...
    public final void a(final Graphics2D graphics2D) {
        ...
        graphics2D.setPaint(Color.BLACK);
        graphics2D.drawString(string, (int)(-fontMetrics.stringWidth(string) / 2.0) + 1, this.b / 2 + 12);
